      ...
      <div style={{ display: 'flex', minHeight: '100vh' }}>
        ...
        <aside style={{
          ...
          <div style={{ padding: '18px 14px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div>
              <div style={{ fontSize: '0.88rem', fontWeight: 700 }}>TrainingPulse</div>
              <div style={{ fontSize: '0.68rem', color: 'var(--text-3)', marginTop: 1 }}>L&D Admin</div>
            </div>
          </div>
              ...
              return (
                <Link key={item.href} href={item.href} style={{ textDecoration: 'none' }} onClick={() => setMobileOpen(false)}>
                  <div style={{
                    ...
                    <span style={{ opacity: active ? 1 : 0.7 }}><Icon name={item.icon} /></span>
          ...
          <div style={{ padding: '10px 8px', borderTop: '1px solid var(--border)' }}>
            <button onClick={handleLogout} style={{
              ...
              padding: '9px 11px', borderRadius: 8, background: 'transparent', border: 'none',
              cursor: 'pointer', color: 'var(--text-3)', fontSize: '0.84rem', fontWeight: 500, fontFamily: 'var(--font)',
            }}>
        ...
        <main style={{ flex: 1, marginLeft: 240, display: 'flex', flexDirection: 'column' }}>
          <header style={{
            display: 'flex', alignItems: 'center', gap: 16, padding: '13px 28px',
            borderBottom: '1px solid var(--border)', background: 'var(--surface)',
            position: 'sticky', top: 0, zIndex: 50,
          }}>
            <h1 style={{ flex: 1, fontSize: '0.97rem', fontWeight: 600 }}>{title}</h1>
            <div style={{
              display: 'flex', alignItems: 'center', gap: 6, padding: '4px 10px',
              borderRadius: 20, background: 'rgba(59,130,246,0.08)',
              border: '1px solid rgba(59,130,246,0.2)',
              color: 'var(--accent)', fontSize: '0.74rem', fontWeight: 500,
            }}>
